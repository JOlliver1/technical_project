...
par1.set_ylabel("Real Cases in the UK")

p6, = par1.plot(np.arange(0, len(spread_data_uk)), spread_data_uk, ':', color='dimgrey', label="Real Cases in the UK")
...
p1, = ax.plot(np.arange(0, steps), new_out, color='blue', label='infection rate=1')
p2, = ax.plot(np.arange(0, steps1), new_out1, color='red', label='infection rate=0.1')
p3, = ax.plot(np.arange(0, steps2), new_out2, color='green', label='infection rate=0.05')
p4, = ax.plot(np.arange(0, steps3), new_out3, color='orange', label='infection rate=0.01')
p5, = ax.plot(np.arange(0, steps4), new_out4, color='pink', label='infection rate=0.005')

ax.legend(handles=[p1, p2, p3, p4, p5], loc='lower right')

par1.yaxis.label.set_color('dimgrey')
par1.set_ylim([0, 400000])
ax.set_ylim([0, np.amax(new_out)+10])
ax.grid(linestyle='--')
