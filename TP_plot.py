...
ax.plot(np.arange(0, steps), new_out, color='blue', label='n=100')
ax.plot(np.arange(0, steps1), new_out1, color='red', label='n=75')
ax.plot(np.arange(0, steps2), new_out2, color='green', label='n=50')
ax.plot(np.arange(0, steps3), new_out3, color='orange', label='n=20')
ax.plot(np.arange(0, steps4), new_out4, color='pink', label='n=10')
ax.set_xlabel('Steps')
