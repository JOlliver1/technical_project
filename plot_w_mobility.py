...
ax.plot(np.arange(0, steps2), new_out2, color='green', label='city=5')
ax.plot(np.arange(0, steps3), new_out3, color='orange', label='city=10')
ax.plot(np.arange(0, steps4), new_out4, color='pink', label='city=15')
ax.set_xlabel('Steps')
